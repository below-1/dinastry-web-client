...
},{"buffer":"../node_modules/buffer/index.js"}],"../src/services/in_bound.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = in_bound;

function in_bound(range, value) {
  // Lower bound
  var lower_bound_ok = false;
  var upper_bound_ok = false;
...
},{}],"../src/services/predict.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.create_predictor = create_predictor;

var _lodash = require("lodash");

var _in_bound = _interopRequireDefault(require("./in_bound"));
...
function transform_attr(_ref) {
  var attr = _ref.attr,
      cls_count = _ref.cls_count,
      total = _ref.total,
      smooth = _ref.smooth;
...
function create_predictor(_ref2) {
  var summary = _ref2.summary,
      total = _ref2.total,
      smooth = _ref2.smooth;
  var classes = Object.keys(summary);
  var modified_summary = classes.reduce(function (acc, cls) {
    var cls_summary = summary[cls];
    var count = cls_summary.count,
        attributes = cls_summary.attributes;
    var _attrs = {};
    Object.keys(attributes).forEach(function (attr_key) {
    ...
    return _objectSpread(_objectSpread({}, acc), {}, _defineProperty({}, cls, {
  ...
  return function (input) {
    ...
    return classes.map(function (c) {
      var attributes = modified_summary[c].attributes;
      var attr_keys = Object.keys(attributes);
      var attr_product = attr_keys.map(function (attr_key) {
        return attributes[attr_key][input[attr_key]];
      }).reduce(function (acc, curr) {
        return acc * curr;
      }, 1); // console.log(modified_summary[c]);
...
},{"lodash":"../node_modules/lodash/lodash.js","./in_bound":"../src/services/in_bound.js"}],"../src/services/row_converter.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = create_row_converter;

var _in_bound = _interopRequireDefault(require("./in_bound"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function create_row_converter(criteria) {
  return function (row) {
    var result = {};
    criteria.forEach(function (c) {
      if (c.kind == 'numeric') {
        var r = c.ranges.find(function (r) {
          return (0, _in_bound.default)(r, row[c.key]);
        });

        if (!r) {
          throw new Error("unknown range for value: [".concat(c.key, ":").concat(row[c.key], "]"));
        }
        ...
        throw new Error("unknown criteria type: ".concat(c.kind));
      }
    });
    return result;
  };
}
},{"./in_bound":"../src/services/in_bound.js"}],"../src/services/testing.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.in_bound = in_bound;
exports.default = testing;

var _lodash = require("lodash");

var _predict = require("./predict.js");

var _row_converter = _interopRequireDefault(require("dinastry/services/row_converter"));
...
function build_sub_attribute(crit) {
  var subs = crit.kind == 'numeric' ? crit.ranges : crit.options;
  return subs.reduce(function (acc, curr) {
    acc[curr.value] = 0;
    return acc;
  }, {});
}
...
function summary(_ref) {
  var data = _ref.data,
      criterias = _ref.criterias;
  var result = build_result_structure(criterias);
  var keys = criterias.map(function (c) {
    return c.key;
  });
  data.forEach(function (d) {
    ...
    criterias.forEach(function (c) {
      ...
      if (c.kind == 'numeric') {
        var _range = c.ranges.find(function (range) {
          return in_bound(range, x);
        });

        try {
          result[d._class].attributes[c.key][_range.value] += 1;
        } catch (err) {
          console.log(c);
          console.log(x);
          throw err;
        ...
        var o = c.options.find(function (o) {
          return o.value == x;
        });
...
function testing(_ref2) {
  var data = _ref2.data,
      criterias = _ref2.criterias;
  var ratios = [0.1, 0.2, 0.3];
  var n_run = 10;
  var row_converter = (0, _row_converter.default)(criterias);
  return ratios.map(function (test_ratio) {
    return (0, _lodash.range)(n_run).map(function (irun) {
      var all = (0, _lodash.shuffle)(data);
      var n_test = Math.floor(all.length * test_ratio);
      var test_data = (0, _lodash.slice)(all, 0, n_test);
      var train_data = (0, _lodash.slice)(all, n_test);
      var summ = summary({
        data: train_data,
        criterias: criterias
      });
      var predictor = (0, _predict.create_predictor)({
        summary: summ,
        smooth: 1,
        total: train_data.length
      });
      var tp = 0;
      var fp = 0;
      var tn = 0;
      ...
      test_data.forEach(function (d) {
        var input = row_converter(d);
        var r = predictor(input);
      ...
      var acc = (tp + tn) / test_data.length * 100;
      var prec = tp / (tp + fp) * 100;
      var recall = tp / (tp + fn) * 100;
...
},{"lodash":"../node_modules/lodash/lodash.js","./predict.js":"../src/services/predict.js","dinastry/services/row_converter":"../src/services/row_converter.js"}],"../src/services/testing_thread.js":[function(require,module,exports) {
"use strict";
...
(0, _worker.expose)({
  run: _testing.default
});
},{"threads/worker":"../node_modules/threads/worker.js","./testing.js":"../src/services/testing.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36785" + '/');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/services/testing_thread.js"], null)
//# sourceMappingURL=/testing_thread.45416cad.js.map